...
--header "Authorization: _dremio${TOKEN}" \
--header 'Content-Type: application/json' \
--data-raw "{\"entityType\":\"source\",\"config\":{\"credentialType\":\"ACCESS_KEY\",\"accessKey\":\"$S3_USERNAME\",\"accessSecret\":\"$S3_PASSWORD\",\"secure\":false,\"externalBucketList\":[],\"enableAsync\":true,\"compatibilityMode\":true,\"enableFileStatusCheck\":true,\"rootPath\":\"/\",\"defaultCtasFormat\":\"PARQUET\",\"propertyList\":[{\"name\":\"fs.s3a.endpoint\",\"value\":\"$S3_ENDPOINT\"},{\"name\":\"fs.s3a.path.style.access\",\"value\":\"true\"}],\"whitelistedBuckets\":[\"$S3_BUCKET\"],\"isCachingEnabled\":true,\"maxCacheSpacePct\":100},\"type\":\"S3\",\"name\":\"S3\",\"metadataPolicy\":{\"authTTLMs\":86400000,\"namesRefreshMs\":3600000,\"datasetRefreshAfterMs\":3600000,\"datasetExpireAfterMs\":10800000,\"datasetUpdateMode\":\"PREFETCH_QUERIED\",\"deleteUnavailableDatasets\":true,\"autoPromoteDatasets\":false},\"accelerationGracePeriodMs\":10800000,\"accelerationRefreshPeriodMs\":3600000,\"accelerationNeverExpire\":false,\"accelerationNeverRefresh\":false,\"allowCrossSourceSelection\":false,\"disableMetadataValidityCheck\":false,\"accessControlList\":{\"userControls\":[],\"roleControls\":[]}}"
