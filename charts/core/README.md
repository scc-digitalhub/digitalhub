...
""
		...
		<tr>
			<td id="authentication--openId--scope"><a href="./values.yaml#L112">authentication.openId.scope</a></td>
			<td>
string
</td>
...
<pre lang="json">
{
  ...
  "serviceName": ""
		...
		<tr>
			<td id="kubeai--enabled"><a href="./values.yaml#L255">kubeai.enabled</a></td>
			<td>
bool
</td>
...
null
		...
		<tr>
			<td id="postgres--credentials--existingSecret--usernameKey"><a href="./values.yaml#L300">postgres.credentials.existingSecret.usernameKey</a></td>
			<td>
string
</td>
...
"1000m"
		...
		<tr>
			<td id="resources--limits--memory"><a href="./values.yaml#L331">resources.limits.memory</a></td>
			<td>
string
</td>
...
"3.10-0.12.0"
		...
		<tr>
			<td id="runtime--python--tag3_11"><a href="./values.yaml#L371">runtime.python.tag3_11</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--databaseProvider--credentials--username"><a href="./values.yaml#L543">sts.databaseProvider.credentials.username</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--fullnameOverride"><a href="./values.yaml#L545">sts.fullnameOverride</a></td>
			<td>
string
</td>
			<td>String to fully override `core.fullname` template.</td>
...
""
		...
		<tr>
			<td id="sts--image"><a href="./values.yaml#L547">sts.image</a></td>
			<td>
object
</td>
			<td></td>
...
<pre lang="json">
{
  ...
  "tag": "0.3.0"
		...
		<tr>
			<td id="sts--image--pullPolicy"><a href="./values.yaml#L549">sts.image.pullPolicy</a></td>
			<td>
string
</td>
			<td>Image pull policy</td>
...
"IfNotPresent"
		...
		<tr>
			<td id="sts--image--repository"><a href="./values.yaml#L551">sts.image.repository</a></td>
			<td>
string
</td>
...
"ghcr.io/scc-digitalhub/db-sts"
		...
		<tr>
			<td id="sts--image--tag"><a href="./values.yaml#L553">sts.image.tag</a></td>
			<td>
string
</td>
...
"0.3.0"
		...
		<tr>
			<td id="sts--imagePullSecrets"><a href="./values.yaml#L558">sts.imagePullSecrets</a></td>
			<td>
list
</td>
...
[]
		...
		<tr>
			<td id="sts--jwt"><a href="./values.yaml#L560">sts.jwt</a></td>
			<td>
object
</td>
			<td></td>
...
<pre lang="json">
{
  ...
  "issuerUri": "http://digitalhub-core:8080"
		...
		<tr>
			<td id="sts--jwt--audience"><a href="./values.yaml#L562">sts.jwt.audience</a></td>
			<td>
string
</td>
...
"sts"
		...
		<tr>
			<td id="sts--jwt--claim"><a href="./values.yaml#L564">sts.jwt.claim</a></td>
			<td>
string
</td>
...
"db/role"
		...
		<tr>
			<td id="sts--jwt--issuerUri"><a href="./values.yaml#L566">sts.jwt.issuerUri</a></td>
			<td>
string
</td>
...
"http://digitalhub-core:8080"
		...
		<tr>
			<td id="sts--nameOverride"><a href="./values.yaml#L568">sts.nameOverride</a></td>
			<td>
string
</td>
			<td>String to partially override `core.fullname` template (will maintain the release name)</td>
...
""
		...
		<tr>
			<td id="sts--nodeSelector"><a href="./values.yaml#L570">sts.nodeSelector</a></td>
			<td>
object
</td>
...
{}
		...
		<tr>
			<td id="sts--podAnnotations"><a href="./values.yaml#L572">sts.podAnnotations</a></td>
			<td>
object
</td>
			<td>Annotations to add to each pod.</td>
...
{}
		...
		<tr>
			<td id="sts--podLabels"><a href="./values.yaml#L574">sts.podLabels</a></td>
			<td>
object
</td>
			<td>Labels to add to each pod.</td>
...
{}
		...
		<tr>
			<td id="sts--podSecurityContext"><a href="./values.yaml#L576">sts.podSecurityContext</a></td>
			<td>
object
</td>
			<td>[Security context for pod](https://kubernetes.io/docs/tasks/configure-pod-container/security-context/)</td>
...
<pre lang="json">
{
  ...
  "seccompProfile": {
    "type": "RuntimeDefault"
		...
		<tr>
			<td id="sts--podSecurityContext--runAsNonRoot"><a href="./values.yaml#L578">sts.podSecurityContext.runAsNonRoot</a></td>
			<td>
bool
</td>
			<td>Pod allow run as root.</td>
...
true
		...
		<tr>
			<td id="sts--podSecurityContext--seccompProfile"><a href="./values.yaml#L580">sts.podSecurityContext.seccompProfile</a></td>
			<td>
object
</td>
			<td>Pod configure seccompProfile.</td>
...
<pre lang="json">
{
  "type": "RuntimeDefault"
		...
		<tr>
			<td id="sts--podSecurityContext--seccompProfile--type"><a href="./values.yaml#L582">sts.podSecurityContext.seccompProfile.type</a></td>
			<td>
string
</td>
			<td>Pod configure seccompProfile type.</td>
...
"RuntimeDefault"
		...
		<tr>
			<td id="sts--replicaCount"><a href="./values.yaml#L584">sts.replicaCount</a></td>
			<td>
int
</td>
			<td>Desired number of pods.</td>
...
1
		...
		<tr>
			<td id="sts--resources"><a href="./values.yaml#L586">sts.resources</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "requests": {
    ...
    "memory": "128Mi"
		...
		<tr>
			<td id="sts--resources--limits"><a href="./values.yaml#L588">sts.resources.limits</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "memory": "256Mi"
		...
		<tr>
			<td id="sts--resources--limits--cpu"><a href="./values.yaml#L590">sts.resources.limits.cpu</a></td>
			<td>
string
</td>
			<td>CPU limit</td>
...
"200m"
		...
		<tr>
			<td id="sts--resources--limits--memory"><a href="./values.yaml#L592">sts.resources.limits.memory</a></td>
			<td>
string
</td>
			<td>Memory limit</td>
...
"256Mi"
		...
		<tr>
			<td id="sts--resources--requests"><a href="./values.yaml#L594">sts.resources.requests</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "memory": "128Mi"
		...
		<tr>
			<td id="sts--resources--requests--cpu"><a href="./values.yaml#L596">sts.resources.requests.cpu</a></td>
			<td>
string
</td>
			<td>CPU request</td>
...
"100m"
		...
		<tr>
			<td id="sts--resources--requests--memory"><a href="./values.yaml#L598">sts.resources.requests.memory</a></td>
			<td>
string
</td>
			<td>Memory request</td>
...
"128Mi"
		...
		<tr>
			<td id="sts--securityContext"><a href="./values.yaml#L600">sts.securityContext</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "seccompProfile": {
    "type": "RuntimeDefault"
		...
		<tr>
			<td id="sts--securityContext--allowPrivilegeEscalation"><a href="./values.yaml#L602">sts.securityContext.allowPrivilegeEscalation</a></td>
			<td>
bool
</td>
...
false
		...
		<tr>
			<td id="sts--securityContext--capabilities"><a href="./values.yaml#L604">sts.securityContext.capabilities</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  "drop": [
    "ALL"
		...
		<tr>
			<td id="sts--securityContext--capabilities--drop"><a href="./values.yaml#L606">sts.securityContext.capabilities.drop</a></td>
			<td>
list
</td>
...
[
  "ALL"
		...
		<tr>
			<td id="sts--securityContext--runAsNonRoot"><a href="./values.yaml#L609">sts.securityContext.runAsNonRoot</a></td>
			<td>
bool
</td>
...
true
		...
		<tr>
			<td id="sts--securityContext--seccompProfile"><a href="./values.yaml#L611">sts.securityContext.seccompProfile</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  "type": "RuntimeDefault"
		...
		<tr>
			<td id="sts--securityContext--seccompProfile--type"><a href="./values.yaml#L613">sts.securityContext.seccompProfile.type</a></td>
			<td>
string
</td>
...
"RuntimeDefault"
		...
		<tr>
			<td id="sts--service"><a href="./values.yaml#L615">sts.service</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "type": "ClusterIP"
		...
		<tr>
			<td id="sts--service--port"><a href="./values.yaml#L617">sts.service.port</a></td>
			<td>
int
</td>
...
8080
		...
		<tr>
			<td id="sts--service--type"><a href="./values.yaml#L619">sts.service.type</a></td>
			<td>
string
</td>
...
"ClusterIP"
		...
		<tr>
			<td id="sts--serviceAccount"><a href="./values.yaml#L621">sts.serviceAccount</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "name": "core-sts"
		...
		<tr>
			<td id="sts--serviceAccount--annotations"><a href="./values.yaml#L623">sts.serviceAccount.annotations</a></td>
			<td>
object
</td>
...
{}
		...
		<tr>
			<td id="sts--serviceAccount--automount"><a href="./values.yaml#L625">sts.serviceAccount.automount</a></td>
			<td>
bool
</td>
...
true
		...
		<tr>
			<td id="sts--serviceAccount--create"><a href="./values.yaml#L627">sts.serviceAccount.create</a></td>
			<td>
bool
</td>
...
true
		...
		<tr>
			<td id="sts--serviceAccount--name"><a href="./values.yaml#L629">sts.serviceAccount.name</a></td>
			<td>
string
</td>
...
"core-sts"
		...
		<tr>
			<td id="sts--stsDb"><a href="./values.yaml#L631">sts.stsDb</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "schema": ""
		...
		<tr>
			<td id="sts--stsDb--credentials"><a href="./values.yaml#L633">sts.stsDb.credentials</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "username": ""
		...
		<tr>
			<td id="sts--stsDb--credentials--existingSecret"><a href="./values.yaml#L636">sts.stsDb.credentials.existingSecret</a></td>
			<td>
object
</td>
...
<pre lang="json">
{
  ...
  "usernameKey": ""
		...
		<tr>
			<td id="sts--stsDb--credentials--existingSecret--name"><a href="./values.yaml#L638">sts.stsDb.credentials.existingSecret.name</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--credentials--existingSecret--passwordKey"><a href="./values.yaml#L640">sts.stsDb.credentials.existingSecret.passwordKey</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--credentials--existingSecret--usernameKey"><a href="./values.yaml#L642">sts.stsDb.credentials.existingSecret.usernameKey</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--credentials--password"><a href="./values.yaml#L645">sts.stsDb.credentials.password</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--credentials--username"><a href="./values.yaml#L648">sts.stsDb.credentials.username</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--database"><a href="./values.yaml#L650">sts.stsDb.database</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--driver"><a href="./values.yaml#L652">sts.stsDb.driver</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--host"><a href="./values.yaml#L654">sts.stsDb.host</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--platform"><a href="./values.yaml#L656">sts.stsDb.platform</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--port"><a href="./values.yaml#L658">sts.stsDb.port</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--stsDb--schema"><a href="./values.yaml#L660">sts.stsDb.schema</a></td>
			<td>
string
</td>
...
""
		...
		<tr>
			<td id="sts--tolerations"><a href="./values.yaml#L662">sts.tolerations</a></td>
			<td>
list
</td>
...
[]
		...
		<tr>
			<td id="sts--volumeMounts"><a href="./values.yaml#L664">sts.volumeMounts</a></td>
			<td>
list
</td>
...
[]
		...
		<tr>
			<td id="sts--volumes"><a href="./values.yaml#L666">sts.volumes</a></td>
			<td>
list
</td>
...
[]
		...
		<tr>
			<td id="templates"><a href="./values.yaml#L670">templates</a></td>
			<td>
list
</td>
...
[]
		...
		<tr>
			<td id="tolerations"><a href="./values.yaml#L673">tolerations</a></td>
			<td>
list
</td>
			<td>List of node taints to tolerate (requires Kubernetes >= 1.6).</td>
...
[]
		...
		<tr>
			<td id="volumeMounts"><a href="./values.yaml#L676">volumeMounts</a></td>
			<td>
list
</td>
			<td>Additional volumes.</td>
...
[]
		...
		<tr>
			<td id="volumes"><a href="./values.yaml#L679">volumes</a></td>
			<td>
list
</td>
			<td>Additional volumes to mount.</td>
